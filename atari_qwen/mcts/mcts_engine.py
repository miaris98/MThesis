...
class MCTSEngine:
    ...
    def search_batch(
        ...
        """Runs MCTS across a batch of environments.
        ...
        for b in range(B):
            pol_r = root_policy_reprs[b] if root_policy_reprs is not None else None
            probs, act, val = self.search_single(
                root_latents[b],
                agent,
                device,
                root_policy_repr=pol_r,
