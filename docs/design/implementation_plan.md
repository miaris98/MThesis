...
#### [MODIFY] [carla_runner.py](../../scripts/carla/carla_runner.py)
...
#### [NEW] [carla_rl_client_demo.py](../../scripts/carla/carla_rl_client_demo.py)
...
#### [NEW] [vastai_setup_guide.md](../guides/vastai_setup_guide.md)
...
#### [MODIFY] [storage_and_installation_guide.md](../guides/storage_and_installation_guide.md)
...
#### [MODIFY] [walkthrough.md](../guides/walkthrough.md)
...
3. Run `python scripts/carla/carla_rl_client_demo.py --host 127.0.0.1 --port 2000 --steps 50` to confirm connection, action execution, step reward calculations, and screenshot generation.
