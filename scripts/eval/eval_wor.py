...
Usage:
    python scripts/eval/eval_wor.py --checkpoint /workspace/checkpoints/wor_10k/best_model.pth --record_video 1
"""
import argparse
import os
import sys
...
# run directly (`python scripts/eval/eval_wor.py`) or imported as `scripts.eval.eval_wor`.
