...
-----
    # one arm
    python scripts/eval/eval_wor_closed_loop.py --checkpoint .../qwen30m_geom_s0/best_model.pth \\
    ...
    python scripts/eval/compare_closed_loop.py --a .../baseline_s0.json --b .../geom_s0.json
"""
import argparse
import glob
...
# run directly (`python scripts/eval/eval_wor_closed_loop.py`) or imported as `scripts.eval.eval_wor_closed_loop`.
