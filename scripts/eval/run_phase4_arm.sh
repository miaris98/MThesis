...
#
# usage: scripts/eval/run_phase4_arm.sh <label> wor <arch> <ckpt> <port> <tm_port> [gpu_rank] [stagger]
#        scripts/eval/run_phase4_arm.sh <label> tcp <ckpt> -  <port> <tm_port> [gpu_rank] [stagger]
set -x
