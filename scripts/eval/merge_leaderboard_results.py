...
usage:
    scripts/eval/merge_leaderboard_results.py --out merged.json --total 112 base.json retry1.json [retry2.json ...]
...
# run directly (`python scripts/eval/merge_leaderboard_results.py`) or imported as `scripts.eval.merge_leaderboard_results`.
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
if _REPO_ROOT not in sys.path:
    sys.path.insert(0, _REPO_ROOT)
from scripts.eval.check_leaderboard_results import classify  # noqa: E402
