...
#
# usage: scripts/eval/run_bench2drive.sh <label> <arch> <ckpt> <routes_xml> <port> <tm_port> [gpu_rank] [routes_subset]
#
...
AGENT="${EVAL_AGENT:-$MTHESIS_ROOT/scripts/eval/bench2drive_agent.py}"
