...
the same --save_dir passed to train_wor.py. One push:
    ...
    python scripts/sync/hf_push_checkpoints.py --local_dir /workspace/checkpoints/wor_full8town/qwen30m_geom_s0 \
        --path_in_repo checkpoints/wor_full8town/qwen30m_geom_s0

Or loop alongside training:

    nohup python scripts/sync/hf_push_checkpoints.py --local_dir ... --path_in_repo ... --loop_seconds 900 &
