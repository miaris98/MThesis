...
Usage:
    python scripts/analysis/compare_wor_runs.py <run_dir> [<run_dir> ...]
    python scripts/analysis/compare_wor_runs.py --glob "experiments/checkpoints/wor_*"
    python scripts/analysis/compare_wor_runs.py --glob "runs/*" --baseline qwen30m_seed0 --csv out.csv
"""
import argparse
import csv
