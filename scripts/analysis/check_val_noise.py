...
Usage:
  python scripts/analysis/check_val_noise.py --checkpoint /workspace/checkpoints/wor_sweep/qwen30m_s0/best_model.pth \
...
# run directly (`python scripts/analysis/check_val_noise.py`) or imported as `scripts.analysis.check_val_noise`.
