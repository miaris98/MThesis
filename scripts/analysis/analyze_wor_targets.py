...
Usage:
    python scripts/analysis/analyze_wor_targets.py --data_dir /workspace/dataset/wor_trajectories
"""
import argparse
import os
import sys
...
# run directly (`python scripts/analysis/analyze_wor_targets.py`) or imported as `scripts.analysis.analyze_wor_targets`.
