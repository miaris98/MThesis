...
Usage:
  python scripts/setup/download_pdm_lite.py --dry-run                    # show the plan, download nothing
  python scripts/setup/download_pdm_lite.py                              # fill the disk, keeping 25 GB free
  python scripts/setup/download_pdm_lite.py --reserve-gb 40              # leave more headroom
  python scripts/setup/download_pdm_lite.py --towns Town01,Town03        # explicit, still disk-checked
  python scripts/setup/download_pdm_lite.py --max-gb 60                  # cap regardless of free space
"""
import argparse
import json
import os
