...
#
# usage: scripts/setup/setup_tfpp_env.sh          (idempotent - exits early if the agent already imports)
#
...
echo "  bash scripts/eval/run_leaderboard_official.sh <label> tfpp - <routes.xml> <subset> <port> <tm_port>"
